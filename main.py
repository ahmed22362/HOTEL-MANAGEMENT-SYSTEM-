...
def roomRent():
    ...
    if customer:
        ...
        if myConnection:
            ...
            print (" 1. Ultra Royal ----> 10000 EGP.")
            print (" 2. Royal ----> 5000 EGP. ")
            print (" 3. Elite ----> 3500 EGP. ")
...
def Restaurent():
    ...
    if customer:
        ...
        if myConnection:
            ...
            cursor.execute(createTable) 
            print("1. Vegetarian Combo -----> 300 EGP.")
            print("2. Non-Vegetarian Combo -----> 500 EGP.")
            print("3. Vegetarian & Non-Vegetarian Combo -----> 750 EGP.")
        ...
        cursor.execute(sql,values)
        cursor.execute("COMMIT")
        print("Your Total Bill Amount Is : EGP. ",restaurentbill)
...
def Gaming():
    ...
    if customer:
        ...
        if myConnection:
            ...
            cursor.execute(createTable)
            print("""
            1. Table Tennis -----> 150 EGP./HR
            2. Bowling -----> 100 EGP./HR
            3. Snooker -----> 250 EGP./HR
            4. VR World Gaming -----> 400 EGP./HR
            5. Video Games -----> 300 EGP./HR
            6. Swimming Pool Games -----> 350 EGP./HR
            7. Exit
            """)
            ...
            cursor.execute(sql,values)
            cursor.execute("COMMIT")
            print("Your Total Gaming Bill Is : EGP. ",gamingbill)
...
def Fashion():
    ...
    if customer:
        ...
        if myConnection:
            ...
            3. Pants -----> 2000 EGP.
            4. Jeans -----> 4000 EGP.
            5. Tassel top -----> 500 EGP.
            6. Gown -----> 3000 EGP.
            7. Western dress -----> 3000 EGP.
            8. Skirts -----> 400 EGP.
            9. Trousers -----> 200 EGP.
            10. InnerWear -----> 30 EGP.
            """)
...
def totalAmount():
    ...
    if customer:
        ...
        if myConnection:
            ...
            print("\n CUSTOMER NAME : " ,name)
            print("\nROOM RENT : EGP. ",roomrent)
            print("\nRESTAURENT BILL : EGP. ",restaurentbill)
            print("\nFASHION BILL : EGP. ",fashionbill) 
            print("\nGAMING BILL : EGP. ",gamingbill)
